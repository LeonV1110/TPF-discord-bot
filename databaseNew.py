...
def getPlayerByDiscordID(discordID):
    ...
    if bool(result):
        ...
        raise err.PlayerNotFound(message = "There is not player with this discordID")
...
def getPlayerBySteam64ID(steam64ID):
    ...
    if bool(result):
        ...
        raise err.PlayerNotFound(message = "There is not player with this steam64ID")
...
def getPlayerByPlayerID(playerID):
    ...
    if bool(result):
        ...
        raise err.PlayerNotFound("There is not player with this playerID")
...
def deletePlayerByDiscordID(discordID):
    ...
    if bool(result):
        ...
        raise err.PlayerNotFound("There is not player with this discordID")
...
def deletePlayerBySteam64ID(steam64ID):
    ...
    if bool(result):
        ...
        raise err.PlayerNotFound("There is not player with this steam64ID")
